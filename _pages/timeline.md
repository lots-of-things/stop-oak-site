...
- **2026-07-13**: Judge rules against lawsuit. The Stop OAK Coalition plans to appeal. [Read part 1 decision here]({{ '/' | relative_url }}assets/images/26.07.13LegalRulingPart1.pdf){:target="_blank"} [Read part 2 decision here]({{ '/' | relative_url }}assets/images/26.07.13LegalRulingPart2.pdf){:target="_blank"} [Read press release here]({{ '/' | relative_url }}assets/images/26.07.13pressrelease.pdf){:target="_blank"}
